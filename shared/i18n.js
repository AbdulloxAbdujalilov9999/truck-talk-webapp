...
"That password is already linked to a different account.": { uz:"Bu parol boshqa hisobga allaqachon bog'langan.", ru:"Этот пароль уже привязан к другому аккаунту." },
"Your account already has a password set — use Change password instead.": { uz:"Hisobingizda parol allaqachon bor — «Parolni o'zgartirish»dan foydalaning.", ru:"У вашего аккаунта уже есть пароль — используйте «Изменить пароль»." },
"For your security, please sign out and sign back in, then try again.": { uz:"Xavfsizlik uchun chiqib, qayta kiring, so'ng yana urinib ko'ring.", ru:"В целях безопасности выйдите и войдите снова, затем повторите попытку." },
/* ---- Settings: add/change password ---- */
"Password login": { uz:"Parol bilan kirish", ru:"Вход по паролю" },
"You can sign in with your email and this password too, as a backup to Google.": { uz:"Google'ga qo'shimcha sifatida, pochtangiz va shu parol bilan ham kira olasiz.", ru:"Вы также можете входить по почте и этому паролю — как запасной способ к Google." },
"Add a password so you can still get in with your email if you ever lose access to Google.": { uz:"Google hisobingizga kira olmay qolsangiz ham pochtangiz orqali kira olishingiz uchun parol qo'shing.", ru:"Добавьте пароль, чтобы вы могли войти по почте, даже если потеряете доступ к Google." },
"Add password": { uz:"Parol qo'shish", ru:"Добавить пароль" },
"Change password": { uz:"Parolni o'zgartirish", ru:"Изменить пароль" },
"Add password login": { uz:"Parol bilan kirishni qo'shish", ru:"Добавить вход по паролю" },
"Enter your current password and a new one.": { uz:"Joriy parolingiz va yangi parolni kiriting.", ru:"Введите текущий пароль и новый." },
"Set a password for {email} so you can sign in without Google.": { uz:"Google'siz kira olishingiz uchun {email} manziliga parol o'rnating.", ru:"Установите пароль для {email}, чтобы входить без Google." },
"Current password": { uz:"Joriy parol", ru:"Текущий пароль" },
"New password": { uz:"Yangi parol", ru:"Новый пароль" },
"Confirm new password": { uz:"Yangi parolni tasdiqlang", ru:"Подтвердите новый пароль" },
"Cancel": { uz:"Bekor qilish", ru:"Отмена" },
"Passwords don't match.": { uz:"Parollar mos kelmadi.", ru:"Пароли не совпадают." },
"Password changed.": { uz:"Parol o'zgartirildi.", ru:"Пароль изменён." },
