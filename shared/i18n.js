...
"We pick the best voice already on your device — it plays instantly.": { uz:"Qurilmangizdagi eng yaxshi ovozni tanlaymiz — u darhol o'ynaydi.", ru:"Мы выбираем лучший голос, уже установленный на устройстве — он воспроизводится мгновенно." },
"About voices": { uz:"Ovozlar haqida", ru:"О голосах" },
"You're using your device's Siri voice": { uz:"Qurilmangizning Siri ovozidan foydalanyapsiz", ru:"Вы используете голос Siri на своём устройстве" },
"Network-based \"online\" voices sound slightly smoother but lag on every tap, so we skip them by default; pick one yourself below if you prefer that trade-off.": { uz:"Internetga ulanadigan «onlayn» ovozlar biroz silliqroq eshitiladi, lekin har bosishda kechikadi, shuning uchun odatda ularni o'tkazib yuboramiz; xohlasangiz pastdan o'zingiz tanlang.", ru:"«Онлайн»-голоса звучат чуть плавнее, но задерживаются при каждом нажатии, поэтому по умолчанию мы их не выбираем; при желании выберите их ниже." },
"Apple devices ship a Siri voice we'll pick up automatically if you install one: Settings → Accessibility → Spoken Content → Voices → English. A true \"Alexa\" voice can't be used here — Amazon doesn't expose it to websites — so Siri (Apple) or a \"Natural\"/\"Neural\" voice (Windows, Android) is the closest a browser can get.": { uz:"Apple qurilmalarida Siri ovozi bor — o'rnatsangiz, avtomatik tanlanadi: Sozlamalar → Maxsus imkoniyatlar → Aytib berish → Ovozlar → English. «Alexa» ovozini bu yerda ishlatib bo'lmaydi — Amazon uni saytlarga bermaydi — shuning uchun Siri (Apple) yoki «Natural»/«Neural» ovoz (Windows, Android) brauzer uchun eng yaqini.", ru:"На устройствах Apple есть голос Siri — мы подхватим его автоматически, если установить: Настройки → Универсальный доступ → Проговаривание → Голоса → English. Голос «Alexa» здесь использовать нельзя — Amazon не даёт его сайтам, — поэтому ближе всего Siri (Apple) или голос «Natural»/«Neural» (Windows, Android)." },
"{name} ({lang}) — recommended": { uz:"{name} ({lang}) — tavsiya etiladi", ru:"{name} ({lang}) — рекомендуется" },
